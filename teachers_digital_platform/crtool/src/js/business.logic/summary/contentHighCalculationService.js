...
const ContentHighCalculationService = {
    ...
    isContentCriterionGroupComplete(currentCriterionGroupName, criterionScore) {
        ...
        } else if (currentCriterionGroupName.indexOf("crt-6")) {
    ...
    calculateSecondCriterion(criterionScore) {
        if (criterionScore.essential_total_yes >= 8) {
            criterionScore.exceeds = true;
    ...
    calculateFourCriterion(criterionScore) {
        if (criterionScore.essential_total_yes >= 9) {
            criterionScore.exceeds = true;
...
export default ContentHighCalculationService;
