...
export default class QualityCriterionPage extends React.Component {
    changeQualityText(e) {
        const qualityText = e.target.value;
        this.props.changeQualityText(qualityText);
    }

    changeQualityRadio(e) {
        this.props.changeQualityRadio("In Progress...");
    }   
            ...
            <div className="CriterionPageTextFormat">
              <div className="block">
                  ...
                  <ol>
                      <li>
                          ...
                          <div className="m-form-field m-form-field__radio">
                              <input className="a-radio" type="radio" name="radio_1" id="test_1" onChange={this.changeQualityRadio.bind(this)} />
                              <label className="a-label" >Yes</label>
                          </div>
                          <div className="m-form-field m-form-field__radio">
                              <input className="a-radio" type="radio" name="radio_1" id="test_2" onChange={this.changeQualityRadio.bind(this)} />
                  ...
                  <p className="m-form-field m-form-field__textarea">
                      ...
                      <br />
                      <textarea className="a-text-input" id="test_7" value={this.props.qualityText} onChange={this.changeQualityText.bind(this)} ></textarea>
                  </p>
              </div>
            </div>
        );
