            ...
            <div className="CriterionPageTextFormat">
              <div className="block">
                  ...
                  <ol>
                      <li>
                          ...
                          <div className="m-form-field m-form-field__radio">
                              <input className="a-radio" type="radio" name="radio_1" id="test_1" />
                              <label className="a-label" >Yes</label>
                          </div>
                          <div className="m-form-field m-form-field__radio">
                              <input className="a-radio" type="radio" name="radio_1" id="test_2" />
                  ...
                  <p className="m-form-field m-form-field__textarea">
                      ...
                      <br />
                      <textarea className="a-text-input" id="test_7"></textarea>
                  </p>
              </div>
            </div>
        );
